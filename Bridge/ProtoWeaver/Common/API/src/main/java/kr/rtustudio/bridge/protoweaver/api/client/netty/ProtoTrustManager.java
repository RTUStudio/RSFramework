package kr.rtustudio.bridge.protoweaver.api.client.netty;
...
public class ProtoTrustManager implements X509TrustManager {
    ...
    private void checkTrusted(X509Certificate[] chain) {
        ...
        if (trusted == null) {
            synchronized (lock) {
                ...
                writer.append(hostId)
                        .append("=")
                        .append(StringUtil.toHexString(fingerprint))
                        .append("\n");
                trusted = fingerprint;
            }
            return;
        ...
        throw new CertificateException(
                "protoweaver-client-cert-error:"
                        + hostId
                        + ":"
                        + StringUtil.toHexString(trusted)
                        + "!="
                        + StringUtil.toHexString(fingerprint));
    }
