...
/**
 * Configurate serializer for serializing/deserializing Adventure {@link Component} to and from
 * MiniMessage format.
 *
 * <p>Adventure {@link Component}를 MiniMessage 형식으로 직렬화/역직렬화하는 Configurate 직렬화기.
 */
