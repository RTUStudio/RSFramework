...
public class InternalConnectionHandler {
    ...
    protected static final Protocol protocol =
            Protocol.create(BridgeChannel.PROXIUM)
                    .setServerHandler(ServerHandshakeHandler.class)
                    .setProxyHandler(ProxyHandshakeHandler.class)
                    .setOptions(
                            BridgeOptions.builder(InternalConnectionHandler.class.getClassLoader())
                                    .build())
