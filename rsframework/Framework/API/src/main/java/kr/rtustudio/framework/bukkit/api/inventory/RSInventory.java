...
/**
 * Handles click, drag, and close events and provides access to plugin resources (translations,
 * notifications, etc.).
 *
 * <p>플러그인별 커스텀 인벤토리 UI의 기반 추상 클래스. 클릭, 드래그, 닫기 이벤트 핸들링과 플러그인 리소스(번역, 알림 등)에 접근할 수 있다.
 *
