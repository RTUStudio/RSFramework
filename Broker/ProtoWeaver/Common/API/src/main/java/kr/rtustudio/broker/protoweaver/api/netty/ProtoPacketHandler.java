...
import kr.rtustudio.broker.protoweaver.api.util.DrunkenBishop;
import kr.rtustudio.broker.protoweaver.api.util.ProtoConstants;
...
public class ProtoPacketHandler extends ByteToMessageDecoder {
    ...
    @Setter private ProtoConnectionHandler handler;
    private ChannelHandlerContext ctx;
    private ByteBuf buf = Unpooled.buffer();

    public ProtoPacketHandler(
            ProtoConnection connection, ConcurrentHashMap<String, Integer> connectionCount) {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        ...
        if (parts[1].contains("protoweaver-client-cert-error")) {
            ...
            ProtoLogger.err(
                    "If you've reset your server configuration recently, you can probably ignore this and reset/remove the \"protoweaver.hosts\" file.");
