package kr.rtustudio.broker.protoweaver.api.client;
...
import kr.rtustudio.broker.protoweaver.api.ProtoWeaver;
import kr.rtustudio.broker.protoweaver.api.client.netty.ProtoTrustManager;
...
import kr.rtustudio.broker.protoweaver.api.protocol.Side;
import kr.rtustudio.broker.protoweaver.api.protocol.handler.ClientConnectionHandler;
import kr.rtustudio.broker.protoweaver.api.protocol.handler.InternalConnectionHandler;
...
public class ProtoClient {
    ...
    public ProtoClient onCertificateRejected(
            @NonNull ProtoTrustManager.CertificateEventHandler handler) {
