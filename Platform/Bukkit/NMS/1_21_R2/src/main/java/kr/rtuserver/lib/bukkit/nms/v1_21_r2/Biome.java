package kr.rtuserver.lib.bukkit.nms.v1_21_r2;
...
public class Biome implements NMSBiome {
    ...
    private final Registry<net.minecraft.world.level.biome.Biome> registry = dedicatedServer.registries().compositeAccess().lookupOrThrow(resourceKey);
    ...
    public List<String> getBiomeTag(String tag) {
        Optional<HolderSet.Named<net.minecraft.world.level.biome.Biome>> holders = registry.get(TagKey.create(resourceKey, ResourceLocation.parse(tag)));
