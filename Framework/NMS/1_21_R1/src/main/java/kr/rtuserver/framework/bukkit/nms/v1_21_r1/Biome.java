package kr.rtuserver.framework.bukkit.nms.v1_21_r1;
...
public class Biome implements NMSBiome {
    ...
    public List<String> getTag(String tag) {
        Optional<HolderSet.Named<net.minecraft.world.level.biome.Biome>> holders = registry.getTag(TagKey.create(resourceKey, ResourceLocation.parse(tag)));
