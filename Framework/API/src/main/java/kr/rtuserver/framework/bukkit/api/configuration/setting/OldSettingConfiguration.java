package kr.rtuserver.framework.bukkit.api.configuration.setting;

import kr.rtuserver.framework.bukkit.api.RSPlugin;
import kr.rtuserver.framework.bukkit.api.configuration.RSConfiguration;
import kr.rtuserver.framework.bukkit.api.configuration.storage.StorageType;
import lombok.Getter;
import lombok.Setter;

@Getter
@Setter
public class OldSettingConfiguration extends RSConfiguration<RSPlugin> {
    ...
    public OldSettingConfiguration(RSPlugin plugin) {
