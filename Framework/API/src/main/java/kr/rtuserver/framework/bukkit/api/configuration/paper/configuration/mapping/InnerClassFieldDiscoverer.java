...
import kr.rtuserver.framework.bukkit.api.configuration.paper.configuration.ConfigurationPart;
...
public final class InnerClassFieldDiscoverer implements FieldDiscoverer<Map<Field, DeserializedFieldInfo<?>>> {
    ...
    public static FieldDiscoverer<?> config(final List<Definition<?, ?, ? extends FieldProcessor.Factory<?, ?>>> fieldProcessors) {
