...
public interface Storage {
    ...
    /**
     * Adds a new JSON object from a JSON wrapper type.
     * Delegates to the add method with JsonObject.
     *
     * @param name The identifier or table/collection name.
     ...
     * @return A CompletableFuture containing the result of the operation.
     */
    CompletableFuture<Result> set(@NotNull String name, @NotNull JsonObject find, @NotNull JsonObject data);

    /**
     * Updates or sets a JSON object from JSON wrapper types.
     * Delegates to the set method with JsonObject.
     *
     * @param name The identifier or table/collection name.
     ...
     * @return A CompletableFuture containing the result of the operation.
     */
    default CompletableFuture<Result> set(@NotNull String name, @NotNull JSON find, @NotNull JSON data) {
    ...
    /**
     * Retrieves a list of JSON objects from JSON wrapper types.
     * Delegates to the get method with JsonObject.
     *
     * @param name The identifier or table/collection name.
