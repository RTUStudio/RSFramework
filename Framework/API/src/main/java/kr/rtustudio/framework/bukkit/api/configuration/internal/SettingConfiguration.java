...
/**
 * Class that manages plugin common settings ({@code Config/Setting.yml}).
 *
 * <p>플러그인 공통 설정({@code Config/Setting.yml})을 관리하는 클래스. 디버그 모드, 리스너 활성화, MOTD, 접두사, 로케일 등의 기본 설정을
 * 포함한다.
 */
@Getter
@Setter
